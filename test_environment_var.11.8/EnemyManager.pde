class EnemyManager {
 ...
 // 底面（地面）の Y 座標
  ...
  enemy1.add(new EnemyData( 1400, hagurumaY,   "haguruma",      1, 0.0f,  2, 10));
  enemy1.add(new EnemyData( 1550, groundY-36,  "flymiira",     -1, 0.7f,  3, 0));
  enemy1.add(new EnemyData( 1700, hagurumaY,   "haguruma",     -1, 0.2f,  2, 10));
  enemy1.add(new EnemyData( 1850, frkY,        "frankenstein",  -1, 0.2f,  7, 2));
  enemy1.add(new EnemyData( 2000, groundY-36, "ookami",       -1, 0.5f,  3, 0));

  // ── ゴール直前：ラスト警戒編隊 ──
  enemy1.add(new EnemyData( 2200, hagurumaY,   "haguruma",      1, 0.0f,  2, 10));
  enemy1.add(new EnemyData( 2350, frkY,        "frankenstein", -1, 0.12f, 8, 2));
  enemy1.add(new EnemyData( 2500, groundY-36, "flymiira",      1, 0.8f,  3, 0));
  enemy1.add(new EnemyData( 2650, groundY-36, "ookami",        1, 0.6f,  3, 0));
    enemy1.add(new EnemyData(
    2500, frkY,
    "frankenstein",
    -1, 0.08f,
 ...
 void setupEnemies(int stageNum) {
  ...
  data.hp,      data.armor
    ...
    /*
      ...
      Hitbox hb = new Hitbox(data.x + 50, data.y, 100, 200);
      add(new Rasubosu(
      hb,
      rasubosuImg,
      player,
